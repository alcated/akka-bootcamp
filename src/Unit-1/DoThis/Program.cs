...
namespace WinTail
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            IActorRef validatorActor = MyActorSystem.ActorOf(fileValidatorActorProps, "fileValidatorActor");

            Props consoleReaderProps = Props.Create<ConsoleReaderActor>(fileValidatorActorProps);
